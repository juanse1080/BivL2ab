...
<body>
  ...
  <div id="deep" class="section" data-stellar-background-ratio="0.1">
    <div class="container">
      ...
      <div class="row justify-content-center mt-3">
        <a href="{{route('deepsars')}}" class="btn btn-common">
          ver mas
        </a>
      </div>
    </div>
          ...
          <div class="col-lg-6 col-sm-12 col-xs-12 mb-4">
            <div class="contact-us">
              ...
              <div class="ml-4 social-icons">
                <ul>
                  <li class="facebook"><a href="https://www.facebook.com/bivl2ab/"><i class="fab fa-facebook-f"></i></a></li>
                  <li class="twitter"><a href="https://twitter.com/bivl2ab"><i class="fab fa-twitter"></i></a></li>
                  <li class="google-plus"><a href="https://www.instagram.com/bivl2ab/"><i class="fab fa-instagram"></i></a></li>
                </ul>
              </div>
