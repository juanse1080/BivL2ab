...
class ProductionSeeder extends Seeder
{
    ...
    public function run()
    {
        Production::create([ /* undergraduate, doctoral, postdotoral */
            'type'  =>  'Paper',
            ...
            'abstract'  =>  'Social media hate speech and fake news have become worldwide phenomena in the digital age. While offensive posts are a problem, it’s even worse when they are inaccurate or wrongly attributed to people through false profiles.',
            'pdf' => 'https://www.php.net/manual/es/function.rand.php',
            'code' => 'https://www.php.net/manual/es/function.rand.php',
        ]);
        ...
        Production::create([
            ...
            'abstract'  => 'In machine learning, fraud is viewed as a classification problem, and when you’re dealing with imbalanced data, it means the issue to be predicted is in the minority. As a result, the predictive model will often struggle to produce real business value from the data, and it can sometimes get it wrong.',
            'pdf' => 'https://www.php.net/manual/es/function.rand.php',
            'code' => 'https://www.php.net/manual/es/function.rand.php',
        ]);
        ...
        Production::create([
            ...
            'abstract'  => 'Vulnerable marine life is under immense threat from illegal poachers around the world. For many years, it was practically impossible to keep tabs on the activities of every boat at sea. These days, advancements in AI, geo-mapping, and cloud computing have combined to realize a brilliant machine learning Production idea: Global Fishing Watch.',
            'pdf' => 'https://www.php.net/manual/es/function.rand.php',
            'code' => 'https://www.php.net/manual/es/function.rand.php',
        ]);
        ...
        Production::create([
            ...
            'abstract'  => 'Hello Barbie is an exciting demonstration of the power of machine learning and artificial intelligence. Through NLP and some advanced audio analytics, Barbie can interact in logical conversation. The microphone on her necklace records whatever is said and then transmits it to the ToyTalk servers, where it is analyzed.',
            'pdf' => 'https://www.php.net/manual/es/function.rand.php',
            'code' => 'https://www.php.net/manual/es/function.rand.php',
        ]);
